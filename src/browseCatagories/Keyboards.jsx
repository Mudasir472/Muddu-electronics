...
export default function Cameras() {
    const { items, status, error } = useSelector((state) => state.keyboardProducts);
    ...
    return (<>
        ...
        {status === "success" && (
            <>
                <Header img={items[0].imageLink} home="Home | Keyboards" main="Favourite Keyboards" />
                {/* <Discount /> */}
                <section className="row mt-4" style={{ backgroundColor: '#f9f9f9' }}>
                    <div className="mainData container col-8 offset-2">
                        {items.map((item) => (
                            <div class="card mb-3 d-flex justify-content-center" style={{ width: "100%", height: "19rem" }}>
